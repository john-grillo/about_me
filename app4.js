...
var arrayAns = ['bacon', 'mangoes', 'sushi'];
var arrayLength = arrayAns.length;
var eightQ = prompt("John lists a few favorite foods. Can you name one of them? Oh, and spelling counts").toLowerCase();
for(var index = 0; index <= arrayLength; index++) {

  if (eightQ == arrayAns[index]) {
    console.log(index, "The user guessed: ", eightQ);
    break;
  } else {
    alert("Bingo! You guessed one of his favorite foods correctly!");
